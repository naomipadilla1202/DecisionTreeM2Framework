...
df = pd.read_csv("/Users/naomipadilla/Downloads/A01745914_momento de Retro_Mod2_Framework/titanic.csv", header=0)
df.head()
...
plot_tree(regressor, filled=True, feature_names=['Pclass', 'Sex', 'Fare', 'Embarked', 'Age'])
plt.show()
...
"""Como podemos comprobar, el modelo funciona de manera apropiada y es posible generalizarlo a la profundidad deseada y con los valores de ejemplo deseados. Para mayor practicidad se recomienda usar uno de los valores de df de X_test, usando la instraucción X_test[i] donde i = 0 a 888.
